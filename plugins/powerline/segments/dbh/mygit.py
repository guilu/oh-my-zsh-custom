...
def git(pl, segment_info,use_path_separator=False,icons=[]):
    ...
    if deatached_head:
        ...
        ret.append({
            ...
            'highlight_groups':   ['deatached_head'],
        ...
        ret.append({
            ...
            'highlight_groups':   ['branch_dirty' if dirty else 'branch_clean'],
        ...
        if has_diverged:
            ...
            if commits_behind > 0:
                ret.append({
                    ...
                    'highlight_groups':   ['commits:behind'],
            ...
            if commits_ahead > 0:
                ...
                'highlight_groups':   ['commits:ahead'],
    ...
    if has_staged > 0 or has_deleted_cached > 0:
        ...
        if not has_modified and not has_renamed and not has_deleted and not has_untracked:
            ret.append({
                ...
                'highlight_groups': ['staged_ready_to_commit'],
